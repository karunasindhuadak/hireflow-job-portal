                  ...
                  >
                    ...
                    <td className="py-3 px-4 border border-gray-700">
                      <a
                        ...
                        className="bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded inline-flex gap-2 items-center hover:bg-cyan-accent/20 transition-colors border border-cyan-accent/30"
                      >
                        Resume{" "}
                        <img
                          className="invert"
                    ...
                    <td className="py-3 px-4 border border-gray-700 relative text-center">
                      {applicant.status === "Pending" ? (
                          ...
                          <div className="z-10 hidden absolute left-0 -translate-x-1/4 top-full pt-2 w-25 group-hover:block">
                            <div className="bg-navy border border-gray-700 rounded shadow-md">
                              <button
                                ...
                                className="block w-full text-center px-4 py-2 text-cyan-accent hover:bg-navy-light"
                              >
                                Accept
                              </button>
                              <button
                                ...
                                className="block w-full text-center px-4 py-2 text-coral-accent hover:bg-navy-light"
                              >
                                Reject
                              </button>
                            </div>
                        ...
                        <span
                          className={`${applicant.status === "Accepted" ? "bg-green-500/20 text-green-400" : "bg-coral-accent/20 text-coral-accent"} px-3 py-1 rounded`}
                        >
                          {applicant.status}
                        </span>
                      )}
