  ...
  return (
    <div className="container 2xl:px-20 mx-auto py-10">
      <div className="bg-gradient-to-r from-purple-800 to-purple-950 text-white text-center py-16 mx-2 rounded-xl">
        ...
        <div className="flex items-center justify-between rounded bg-white max-w-xl text-gray-600 pl-4 mx-4 sm:mx-auto">
          <div className="flex items-center">
            <img className="h-4 sm:h-5" src={assets.search_icon} alt="" />
            <input
              className="max-sm:text-sm p-2 outline-none rounded w-full"
              ref={titleRef}
              type="text"
